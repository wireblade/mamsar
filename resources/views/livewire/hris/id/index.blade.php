...
>
    <div class="flex justify-between item-center mb-4">
        <a href="{{ @route('id.create') }}">
            <button
                class="px-2 py-1.5 rounded-md text-sm text-white bg-gray-600 hover:bg-gray-800 transition duration-200"
            >
                Create New ID
            </button>
        </a>
    ...
    <div
        class="mt-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg w-full overflow-x-auto"
    >
        <div
            class="grid gap-6 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-5"
        >
            @foreach ($employees as $employee)
                ...
                >
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-5">
                        <!-- Signature -->
                        <div>
                            <p class="text-sm font-medium text-gray-600 mb-2">Signature</p>

                            <img
                                src="{{ asset('storage/' . $employee->image?->path . '/' . $employee->image?->sig) }}"
                        ...
                        <!-- Government ID -->
                        <div>
                            <p class="text-sm font-medium text-gray-600 mb-2">Government IDs</p>
                    ...
                    <div class="flex justify-end gap-2 mt-6 border-t pt-4">
                        <a
                            href="{{ route('show.id', $employee->id) }}"
                        ...
                        <a
                            href="{{ route('id.edit', $employee->id) }}"
        ...
        <!-- Pagination -->
        <div
            class="p-4 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700"
        >
